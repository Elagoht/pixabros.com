...
const HomepagePage = lazy(() => import("@/app/(panel)/homepage/page"));
const SiteSettingsPage = lazy(() => import("@/app/(panel)/site-settings/page"));
const MediaPage = lazy(() => import("@/app/(panel)/media/page"));
