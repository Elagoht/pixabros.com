...
describe("FieldSet", () => {
  ...
  it("renders description when provided", () => {
    render(
      <FieldSet legend="Info" description="Fill in details">
        Content
      </FieldSet>,
    );
  ...
  it("renders icon when provided", () => {
    render(
      <FieldSet legend="Info" icon={IconUser}>
        Content
      </FieldSet>,
    );
  ...
  it("renders error message", () => {
    render(
      <FieldSet legend="Info" error="Something went wrong">
        Content
      </FieldSet>,
    );
  ...
  it("applies error border class", () => {
    render(
      <FieldSet legend="Info" error="Error">
        Content
      </FieldSet>,
    );
    expect(screen.getByText("Content").closest("fieldset")).toHaveClass(
      "border-red-300",
    );
  });
});
